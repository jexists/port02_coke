...
const brBox = [
	...
	{logo: 'coke_logo.png', logow:'coke_logo_w.png', brand: '코카콜라 제로', pic:'coke_zero.png', link:'#',
		text:'이젠 슬림하게, 가볍게 마셔요~!', bgc:'#c3121f'},
...
const brandUl = $('#allProd').children('ul');
...
const moreBtn = $('#allProd').find('button');
